#ifndef VME_HARDWARE_INCLUDE_SIS3316_HH_
#define VME_HARDWARE_INCLUDE_SIS3316_HH_
...
class Sis3316 : public VmeBase, public WfdBase {
 ...
 public:
  ...
  //        and sampling rate
  Sis3316(std::string name, std::string conf, int trace_len);
 ...
 private:
  ...
  const static uint kNumChannelGroups = 4;
  const static uint kMaxQueueSize = 100;
